...
- **What:** Sudden increase of commands associated with domain discovery and information gathering. Suspicious processes:
  ...
  - Lastly, **Source Process** being "cmd.exe", this means that revshell.exe launched cmd.exe (payload opening command prompt, establishing a connection back to the attacker (reverse shell)).
